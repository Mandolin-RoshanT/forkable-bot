...
// Exhaustiveness helper for the discriminated unions above. Place in a
// `default:` arm so adding a new kind to the union forces a compile error
// at every consumer instead of silently falling through.
